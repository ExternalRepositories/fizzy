...
TEST(execute, imported_two_functions)
{
    ...
    */
    ...
    constexpr auto host_foo1 = [](Instance&, const Value* args, int) -> ExecutionResult {
        return Value{args[0].i32 + args[1].i32};
    };
    constexpr auto host_foo2 = [](Instance&, const Value* args, int) -> ExecutionResult {
        return Value{args[0].i32 * args[1].i32};
    };
...
TEST(execute, imported_function_traps)
{
    ...
    */
    ...
    constexpr auto host_foo = [](Instance&, const Value*, int) { return Trap; };
